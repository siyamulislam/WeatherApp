...
//
//     final forecastWeatherRes = forecastWeatherResFromJson(jsonString);

import 'dart:convert';

ForecastWeatherRes forecastWeatherResFromJson(String str) => ForecastWeatherRes.fromJson(json.decode(str));

String forecastWeatherResToJson(ForecastWeatherRes data) => json.encode(data.toJson());

class ForecastWeatherRes {
  ForecastWeatherRes({
    required this.cod,
